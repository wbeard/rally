function Spiral(/*number*/ num) {
  ...
  Array.prototype.indexIsOutOfBounds = function(num) {
  ...
  var directions = {
    ...
    odddirectionSequenceArray = [directions.right, directions.down, directions.left, directions.up],
    evendirectionSequenceArray = [directions.down, directions.left, directions.up, directions.right];
  ...
  function makeSpiral(/* number */ num) {
    var dimensions = matrixDimensions(num+1),
        ...
        directionSequenceArray = (num + 1) % 2 === 0 ? evendirectionSequenceArray : odddirectionSequenceArray,
        directionCounter = 0,
    ...
    for(var integerCounter = 1; integerCounter <= num; integerCounter++) {
        ...
        if(directionSequenceArray.indexIsOutOfBounds(directionCounter)) {
          directionCounter = 0;
        }
        ...
        workingX = workingX + directionSequenceArray[directionCounter][0];
        workingY = workingY + directionSequenceArray[directionCounter][1];
